...
export default function Index() {
  ...
  return (
    <div className="article-container">
      ...
      <ArticleHeadline
        title="After 20 Years Treating Women's Hormonal Changes, I Finally Understand Why Pooch Fat Won't Budge—And How Women Are Losing Inches In 8 Weeks Without Restrictive Diets"
